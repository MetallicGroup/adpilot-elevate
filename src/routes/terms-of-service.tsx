...
export const Route = createFileRoute("/terms-of-service")({
  ...
  component: () => (
    <LegalPage title="Termeni și condiții" updated="10 iunie 2026">
      ...
      <H2>1. Serviciile</H2>
      <P>AdPilot oferă o platformă SaaS care ajută afacerile să creeze, administreze, optimizeze și raporteze campanii de publicitate pe TikTok și Meta. Serviciile includ instrumente de creare campanii, generare de creativ cu AI, livrare de clienți potențiali, dashboarduri de analitică și un asistent conversațional pe WhatsApp.</P>
      ...
      <P>Pentru a opera campanii, trebuie să conectezi contul tău de reclame TikTok sau Meta la AdPilot prin fluxul OAuth oficial. Confirmi că ai dreptul și autoritatea de a acorda AdPilot acces la aceste conturi. Conturile rămân mereu ale tale — AdPilot acționează doar la instrucțiunile tale și în limita permisiunilor acordate.</P>
      ...
      <P>Trebuie să respecți și politicile de publicitate ale TikTok și Meta.</P>
      ...
      <P>Abonamentul acoperă doar accesul la platformă. Bugetul de reclame este facturat direct de TikTok / Meta și nu este inclus.</P>
