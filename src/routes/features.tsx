...
const features = [
  { icon: Megaphone, title: "Management reclame TikTok & Meta", items: ["Creare campanii cap-coadă", "Administrare în masă", "Buget zilnic sau total", "Monitorizare în timp real"] },
  ...
  { icon: Inbox, title: "Generare clienți potențiali", items: ["Formulare native TikTok & Meta", "Notificări instant", "Pregătit pentru CRM", "Alerte pe WhatsApp"] },
...
function FeaturesPage() {
  return (
    <MarketingLayout>
      <PageHero eyebrow="Funcționalități" title="Tot ce ai nevoie pentru reclame care vând." subtitle="De la creare până la livrarea clienților, AdPilot acoperă tot ciclul unei campanii TikTok sau Meta." />
