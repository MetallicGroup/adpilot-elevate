...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AdPilot — Reclame Facebook & Instagram. Simplu." },
      { name: "description", content: "Lansează, administrează și optimizează reclame Facebook & Instagram dintr-o singură aplicație. 7 zile gratuit." },
      { name: "author", content: "AdPilot" },
      { property: "og:title", content: "AdPilot — Reclame Facebook & Instagram. Simplu." },
      { property: "og:description", content: "Lansează, administrează și optimizează reclame Facebook & Instagram dintr-o singură aplicație. 7 zile gratuit." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "AdPilot — Reclame Facebook & Instagram. Simplu." },
      { name: "twitter:description", content: "Lansează, administrează și optimizează reclame Facebook & Instagram dintr-o singură aplicație. 7 zile gratuit." },
