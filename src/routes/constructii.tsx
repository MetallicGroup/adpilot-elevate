...
const niche = NICHES.constructii;

export const Route = createFileRoute("/constructii")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://adpilot.ro/constructii" },
    ],
    links: [{ rel: "canonical", href: "https://adpilot.ro/constructii" }],
  }),
