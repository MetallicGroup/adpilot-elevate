  ...
  return (
    <MarketingLayout>
      ...
      <section className="px-6 pb-20 max-w-3xl mx-auto w-full space-y-8 text-muted-foreground leading-relaxed">
        ...
        <p>TikTok și Meta sunt cele mai puternice canale de achiziție de clienți ale deceniului — și merită un instrument care vine la nivelul oamenilor. AdPilot înlocuiește agenția cu un co-pilot AI care construiește, lansează și optimizează campanii în câteva minute, nu săptămâni.</p>
